...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        site_data = filtered_df.groupby(["Launch Site"])["class"].sum().reset_index()
        print(site_data)
        ...
        site_data = site_data.groupby("class")['class'].value_counts().reset_index()
        fig = px.pie(site_data, values='count', names='class',
        title='Total Success Launches by Site')
        return fig
